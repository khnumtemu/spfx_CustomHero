...
require('bootstrap');
var CustomHeroCarouselWebPart = /** @class */ (function (_super) {
    __extends(CustomHeroCarouselWebPart, _super);
    function CustomHeroCarouselWebPart() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    //Retrieve all the attachments from all items in a SharePoint List  
    CustomHeroCarouselWebPart.prototype.getSPData = function () {
        var _this = this;
        var attachmentfiles = "";
        var partOne = "";
        var partTwo = "";
    ...
    CustomHeroCarouselWebPart.prototype.renderData = function (strResponse) {
        var htmlElement = this.domElement.querySelector("#CustomHeroImageLIst");
        htmlElement.innerHTML = strResponse;
    };
    CustomHeroCarouselWebPart.prototype.render = function () {
    ...
    Object.defineProperty(CustomHeroCarouselWebPart.prototype, "dataVersion", {
        get: function () {
    ...
    CustomHeroCarouselWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
    ...
    return CustomHeroCarouselWebPart;
}(BaseClientSideWebPart));
export default CustomHeroCarouselWebPart;
//# sourceMappingURL=CustomHeroCarouselWebPart.js.map