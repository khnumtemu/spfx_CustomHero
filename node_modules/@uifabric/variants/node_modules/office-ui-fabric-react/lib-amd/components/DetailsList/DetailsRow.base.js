    ...
    var DetailsRowBase = /** @class */ (function (_super) {
        ...
        function DetailsRowBase(props) {
            ...
            _this._updateDroppingState = function (newValue, event) {
                var _a = _this.state, selectionState = _a.selectionState, isDropping = _a.isDropping;
                var _b = _this.props, dragDropEvents = _b.dragDropEvents, item = _b.item;
                if (!newValue) {
                ...
                if (isDropping !== newValue) {
                    _this.setState({ selectionState: selectionState, isDropping: newValue });
                }
            };
        ...
        DetailsRowBase.prototype.render = function () {
            ...
            _e = _a.rowFieldsAs, 
            /** Alias rowFieldsAs as RowFields and default to DetailsRowFields if rowFieldsAs does not exist */
            RowFields = _e === void 0 ? DetailsRowFields_1.DetailsRowFields : _e, selection = _a.selection, indentWidth = _a.indentWidth, shimmer = _a.shimmer, enableUpdateAnimations = _a.enableUpdateAnimations, compact = _a.compact, theme = _a.theme, styles = _a.styles, cellsByColumn = _a.cellsByColumn, useFastIcons = _a.useFastIcons;
