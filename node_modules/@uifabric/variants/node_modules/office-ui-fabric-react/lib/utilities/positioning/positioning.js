 ...
 */
function _finalizeReturnEdge(elementRectangle, returnEdge, bounds, previousPositions) {
 ...
 */
function _finalizeElementPosition(elementRectangle, hostElement, targetEdge, bounds, alignmentEdge, coverTarget, previousPositions) {
    var returnValue = {};
    var hostRect = _getRectangleFromElement(hostElement);
    var elementEdge = coverTarget ? targetEdge : targetEdge * -1;
    var elementEdgeString = RectangleEdge[elementEdge];
    var returnEdge = _finalizeReturnEdge(elementRectangle, alignmentEdge ? alignmentEdge : _getFlankingEdges(targetEdge).positiveEdge, bounds, previousPositions);
 ...
 */
function _finalizePositionData(positionedElement, hostElement, bounds, coverTarget, previousPositions) {
    var finalizedElement = _finalizeElementPosition(positionedElement.elementRectangle, hostElement, positionedElement.targetEdge, bounds, positionedElement.alignmentEdge, coverTarget, previousPositions);
    return {
...
function _positionCallout(props, hostElement, callout, previousPositions) {
    ...
    return tslib_1.__assign({}, _finalizePositionData(positionedElement, hostElement, boundingRect, props.coverTarget, !!previousPositions), { beakPosition: finalizedBeakPosition });
}
