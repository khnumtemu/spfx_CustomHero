define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "isUndefinedValidateError": "***Ţħę väŀũĕ ƒŏŗ \"{0}\" můşţ ŉőţ ƅȅ ŭŋďęƒıņėđ",
      ...
      "serviceScopeConsumingBeforeFinished": "***Čàƞŉơţ ĉơņşůmě šėřvıčȅś ƀēċȃůśě ţĥě śćơƿĕ ĭş ņơŧ ƒĭņĩśĥȅđ ƴėŧ",
