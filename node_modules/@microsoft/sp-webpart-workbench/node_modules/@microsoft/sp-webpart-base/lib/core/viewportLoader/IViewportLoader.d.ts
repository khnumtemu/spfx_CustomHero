 ...
 */
interface IViewportLoader<TComponent extends IViewportAwareComponent> {
    /**
     ...
     */
    register: (component: TComponent, scrollableParent?: HTMLElement) => void;
    /**
     * Releases viewport aware component from waiting queue and renders it, overriding the
     * requirement for the component to be rendered within the viewport.
     */
    release: (component: TComponent) => boolean;
}
